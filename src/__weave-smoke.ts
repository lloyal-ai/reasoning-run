 ...
 * `weaveSourcesIntoResult` and exercises its behavior directly. Ported 1:1 from
 * the validated dist patch's `test_weave.js` (9 cases): bare-url weave + Sources
 * append, already-linked skip, prefix-collision ordering, empty/undefined/
 * non-string defensiveness, parens guard, dedup, and malformed-entry skip.
 */
